...
public class HerbertLogBonusTest {
	...
	public void testLongNamesTotalSalary() {
		...
		int salary = log.calculateSalary();
		System.out.println("test total salary long"+log.m_numGets);
