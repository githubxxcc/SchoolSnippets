...
public class ListSimulator {
	...
	static public void main(String[] args){
		...
		FixedLengthList lRandom = new SearchWithNegative(LISTSIZE);		
		ListSimulator tRandom = new ListSimulator(TestType.RANDOM, lRandom);
		
		FixedLengthList lUp = new SearchWithNegative(LISTSIZE);
		ListSimulator tUp = new ListSimulator(TestType.INCREASING, lUp);
		
		FixedLengthList lDown = new SearchWithNegative(LISTSIZE);
